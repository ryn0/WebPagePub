...
{
    public class ArticleTopicExpansionGenerator : BaseGenerator, IExecute
    {
        ...
        public async Task Execute()
        {
            ...
            // 01
            System.Console.Write($"Getting {QuestionQuantity} questions for '{Topic}'...");
            ...
            foreach (var question in questionList)
            {
                ...
                System.Console.Write($"Creating article for {question}...");
                ...
                {
                    System.Console.WriteLine(" - Article title is wrong");
                    continue;
                }
                ...
                if (attemptsMade > maxAttempts)
                {
                    System.Console.WriteLine(" - Meta description is too short");
                    continue;
                }
